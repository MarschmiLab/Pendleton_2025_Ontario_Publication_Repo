...
```{r FIGURE-S5A, fig.width = 3, fig.height=1}
...
```{r FIGURE-S6A, fig.width = 8, fig.height = 6}
...
```{r FIGURE-S5B, fig.width=20, fig.height=8}
...
```{r FIGURE-S13B, fig.height=3, fig.width=3.5}
...
```{r FIGURE-S13C, fig.height=3, fig.width=3.5}
...
```{r FIGURE-S14CF, fig.width = 8, fig.height = 6.5}
...
```{r FIGURE-S14B, fig.width = 3.75, fig.height = 3}
...
```{r FIGURE-S14A, fig.height=4, fig.width=4.5}
