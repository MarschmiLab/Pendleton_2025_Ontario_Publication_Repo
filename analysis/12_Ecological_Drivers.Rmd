...
icamp_wd_env2 <- "data/12_ecological_drivers/pd_wd_env2/"
...
save(pd.big2, file = "data/12_ecological_drivers/pd.big2.RData")
...
niche.dif<-iCAMP::dniche(env = env,
                        ...
                        out.dist=FALSE,
                        bigmemo=TRUE,
                        nd.wd="data/12_ecological_drivers/output_env2")
...
load("data/12_ecological_drivers/pd.big2.RData")
